...
export default function Sidebar () {
    return (
        <div className={styles.sidebar}>
            ...
            {/* picture */}
            <Image 
                src='https://90-days-blog.s3.eu-west-2.amazonaws.com/picture_of_me.png'
                alt="picture of me"
                width='150%'
                height='150%'
            ...
            <li className={styles.list}>
                <ul>
                    ...
                    &nbsp;incheslewis-at-gmail-dot-com</ul>
                <ul>
                    ...
                    &nbsp;<a className={styles.link} href='http://www.github.com/LewisI224'>github.com/LewisI224</a></ul>
                <ul>
                    ...
                    &nbsp;<a className={styles.link} href='http://www.linkedin.com/in/lewisinches/'>linkedin.com/in/lewisinches/</a></ul>
            </li>
        </div>
    )
